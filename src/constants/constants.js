...
export const content ={
    myname: 'Alexander Tu',
    skillsAndExp: 'Technology: Java, C++, C#, Python, Javascript, Typescript, HTML, CSS, Latex, Oracle, MySQL, Mssql, Postgresql, Word, Excel, BashScript, Shell Script, Github',
    ...
    aboutwebsite: 'I plan to remake this website using Vite as build tool cuz its faster and Typescript cuz I want to learn it. This website was built using ReactJS and components from Material UI. Currently still improving it. Footer is scuffed, looking into materil ui documentation to learn the components. ',
