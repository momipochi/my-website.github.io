...
export const content ={
    ...
    personalProjects: 'Youtube and Netflix website clone (html,css,js), React websites, Python web-scraper, university projects',
    ...
    aboutwebsite: 'This website was built using ReactJS and components from Material UI'
